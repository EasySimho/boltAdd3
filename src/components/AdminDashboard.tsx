...
import { Plus, Save, LogOut, Calendar, Clock, Users, Trash2, Edit, X, ChevronLeft, User } from 'lucide-react';
              ...
              {shifts.map((shift) => (
                ...
                >
                  ...
                  <div className="flex items-center mb-4">
                    <Calendar className="h-5 w-5 text-[#E2001A] mr-2" />
                          ...
                          {participantsInRole.length > 0 && (
                            <div className="mt-2 space-y-1">
                              {participantsInRole.map(([_, participant]) => (
                                <div key={participant.name} className="flex items-center text-sm text-gray-600">
